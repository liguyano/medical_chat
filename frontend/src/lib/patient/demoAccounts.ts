...
export const patientDemoAccounts: PatientDemoAccount[] = [
  ...
  { name: '陈建军', idCardNo: '110101195801180043', phone: '13800000004' },
  { name: '赵敏', idCardNo: '110101195509300051', phone: '13800000005' },
  { name: '周海燕', idCardNo: '110101195206150028', phone: '13800000006' },
  { name: '孙志伟', idCardNo: '110101196212080035', phone: '13800000007' },
  { name: '杨秀梅', idCardNo: '110101195904220026', phone: '13800000008' },
  { name: '黄建国', idCardNo: '110101195010090019', phone: '13800000009' },
  { name: '林晓莉', idCardNo: '11010119600214002X', phone: '13800000010' },
];
